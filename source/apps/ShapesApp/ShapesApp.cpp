...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"../source/apps/ShapesApp/color.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"../source/apps/ShapesApp/color.hlsl", nullptr, "PS", "ps_5_1");
